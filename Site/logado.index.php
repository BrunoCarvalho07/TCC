...
<header class="cabecalho">
	...
	<a href="#" class="usuario" title="usuário">Olá, <?php echo $id; ?></a><br>
	<a href="pag/status.php" class="agendamentos" title="Status">agendamentos</a><br>
	<a href="pag/processamento/logout.php" class="sair" title="Sair">sair</a>
</header>
<section>
	<div class="container-fluid chrome" id="agenda" ><!-- Agendamento -->
		<div class="consultas-agendar" >
			...
			<a href="pag/agendamento.php" class="buttonagen">agendar</a>
		</div>
	</div>
